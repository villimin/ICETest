...
namespace ICE_Villy_Test
{
    public static class FileManager
    {
        ...
        public static bool DownloadFileIfNotExists(DateTime forecastDate, DateTime currentDate, out string errorMessage, ref string filePath)
        {
            errorMessage = string.Empty;

            try
            {
                int offsetDays = (int)(forecastDate - currentDate).TotalHours;
                string time = currentDate.ToString("yyyymmdd");
